/* ============================================================
   TASF 2026 — Boot animation + site init
   ============================================================ */

const BOOT_LINES = [
  { text: "BIOS v2.1.4  |  TASF SECURE BOOT INIT", cls: "log-dim", delay: 0 },
  { text: "", cls: "log-dim", delay: 8 },
  { text: "[ 0.000] Starting TASF kernel security module...", cls: "log-dim", delay: 16 },
  ...
  { text: "> git clone tasf-2026-ctf --depth 1", cls: "log-info", delay: 290 },
  { text: "  Cloning into 'tasf-2026-ctf'...", cls: "log-dim", delay: 298 },
  ...
  { text: "> tasf-init --load-config event.toml", cls: "log-info", delay: 370 },
  { text: "  [config] location     = Tel Aviv, IL", cls: "log-dim", delay: 378 },
  { text: "  [config] venue        = Tel Aviv Museum of Art", cls: "log-dim", delay: 382 },
  { text: "  [config] date         = 2026-11-22 (Sunday)", cls: "log-dim", delay: 386 },
  { text: "  [config] ends         = ~20:00 IST · dinner to close", cls: "log-dim", delay: 394 },
  { text: "  [config] capacity     = application-based", cls: "log-dim", delay: 402 },
  ...
  { text: "  All systems nominal. Launching TASF 2026...", cls: "log-ok", delay: 544 },
...
function updateClock() {
  ...
  const target = new Date("2026-11-22T09:00:00+02:00");
